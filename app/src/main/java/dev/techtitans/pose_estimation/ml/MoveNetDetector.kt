package dev.techtitans.pose_estimation.ml

import android.content.Context
import android.graphics.*
import android.os.SystemClock
import dev.techtitans.pose_estimation.data.*
...
/**
 * Interface for pose detectors that process images and return pose estimations
 */
...
/**
 * Model type options for MoveNet
 */
enum class ModelType {
    Lightning,  // Faster but less accurate
    Thunder     // Slower but more accurate
}

/**
 * MoveNet implementation of the PoseDetector interface
 */
